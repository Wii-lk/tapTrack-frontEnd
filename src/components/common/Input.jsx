  ...
  return (
    <div className={`mb-5 group ${className}`}>
      ...
      <div className="relative">
        {Icon && (
          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none transition-colors duration-200 group-focus-within:text-primary-600">
            <Icon
          ...
          className={`
            ...
            ${
              error
                ...
                : "border-gray-200 focus:border-primary-600 hover:border-gray-300"
            }
      ...
      {error && (
        <div className="mt-1.5 flex items-center text-sm text-red-500 animate-fade-in ml-1">
