  ...
  const HistoryCard = ({ record }) => (
    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 mb-3">
      <div className="flex justify-between items-start mb-2">
        ...
        <span
          className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full capitalize ${getStatusChip(record.status)}`}
        >
          {record.status}
        </span>
      </div>
              ...
              {!loading &&
                records.map((record) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full capitalize ${getStatusChip(record.status)}`}
                      >
                        {record.status}
                      </span>
                    </td>
